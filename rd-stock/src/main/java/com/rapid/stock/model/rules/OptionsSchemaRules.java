...
public class OptionsSchemaRules {
       ...
       public String uniqueName(String name, String companyId) {
        ...
        public void productsOfSameCompany(List<ProductVersion> productVersions, String companyId) {
               if( productVersions != null && !productVersions.isEmpty() &&
                   productVersions.stream().anyMatch( pv -> !pv.getParentProduct().getCompanyId().equals(companyId)) )
